            ...
            @if (config('filament-breezy.enable_2fa'))
                ...
                <x-filament-breezy::grid-section class="mt-8">
                    ...
                    <x-filament::card class="col-span-2 sm:col-span-1 mt-5 md:mt-0">
                            ...
                            @if ($this->showing_two_factor_recovery_codes)
                                ...
                                <div class="space-y-2">
                                    @foreach (json_decode(decrypt($this->user->two_factor_recovery_codes), true) as $code)
                                        <span
                                            class="inline-flex items-center p-2 rounded-full text-xs font-medium bg-gray-100 text-gray-800">{{ $code }}</span>
                                    @endforeach
                                </div>
                        ...
                        @else
                            <p class="text-lg font-medium text-gray-900 dark:text-white">
                                {{ __('filament-breezy::default.profile.2fa.not_enabled.title') }}</p>
