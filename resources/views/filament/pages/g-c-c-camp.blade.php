            ...
            <div class="filament-forms-section-content-wrapper">
                <div class="filament-forms-section-content p-6">
                    <div class="grid grid-cols-1 filament-forms-component-container gap-6">
                        <ul>
                            <ul>
                                <li>العمر: يجب أن يكون عمر المشارك بين 20 و29 سنة.</li>
                                ...
                                <li>الأسئلة المرفقة: سيتم اختيار المشاركين بناًء على إجاباتهم على الأسئلة المرفقة في
                                    استمارة التسجيل.
                                </li>
                                <li>سوف يتم الأخذ بعين الإعتبار في إختيار المشاركين بناءاً على الأسئلة المرفقة</li>
                            </ul>
                        </ul>
                    </div>
                </div>
